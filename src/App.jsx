...
const firebaseConfig = {
  apiKey: "AIzaSyBbnGak1Gv_RApTJyj-kb1LVaqUH8dwTck",
  authDomain: "hatri-pick-club.firebaseapp.com",
  databaseURL: "https://hatri-pick-club-default-rtdb.firebaseio.com",
  projectId: "hatri-pick-club",
  storageBucket: "hatri-pick-club.firebasestorage.app",
  messagingSenderId: "837996366074",
  appId: "1:837996366074:web:514e0f76b692701e6ea143"
};
    ...
    <div style={{minHeight:"100vh",background:"#0d1117",display:"flex",alignItems:"center",justifyContent:"center",padding:16}}>
      ...
      <div style={{width:"100%",maxWidth:380,animation:"fadeIn .4s ease"}}>
        <div style={{textAlign:"center",marginBottom:28}}>
          ...
          <div style={{fontSize:24,fontWeight:900,color:"#68d391",marginTop:8}}>Hatri Pick Club</div>
...
export default function App() {
  ...
  const save = useCallback(async (d) => {
    setDb(d);
    try { await set(dbRef(), d); } catch(e) { console.warn("Firebase save failed", e); }
  },[]);
      ...
      <div style={{background:"linear-gradient(135deg,#1a2a1a,#0d1f1a)",borderBottom:"1px solid #1e3a2a",padding:"13px 14px 0",position:"sticky",top:0,zIndex:50}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
          <div style={{display:"flex",alignItems:"center",gap:8}}>
            ...
            <div>
              <div style={{fontWeight:900,fontSize:15,color:"#68d391"}}>Hatri Pick Club</div>
